package std29006.Projeto_02.client;
 ...
 */
public class Cliente_III implements ListaServicosClientes {
    ...
    public static void main(String args[]) {
        try {
            ...
            ListaServicosClientes cliente = new Cliente_III();
            ...
            Logger.getLogger(Cliente_III.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public int[][] matrizResultante(int[][] m1, int[][] m2) throws RemoteException {
        int[][] resultado = new int[m1.length+m2.length][m2[0].length];
