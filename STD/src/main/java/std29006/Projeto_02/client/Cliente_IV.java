 ...
 */
public class Cliente_IV implements ListaServicosClientes {
    ...
    public static void main(String args[]) {
        try {
            ...
            ListaServicosClientes cliente = new Cliente_IV();
            ...
            Logger.getLogger(Cliente_IV.class.getName()).log(Level.SEVERE, null, ex);
